package br.com.stockxpert.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof br.com.stockxpert.service.EmailAlreadyUsedException ||
            ex instanceof br.com.stockxpert.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof br.com.stockxpert.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "br.com.stockxpert");
    }
}
